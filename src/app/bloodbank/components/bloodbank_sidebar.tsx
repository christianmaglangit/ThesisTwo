...
export default function BloodbankSidebar() {
  ...
  const links = [
    ...
    { name: "View Receipt Confirmation", href: "/bloodbank/bloodbank_receiptconfirm" },
  ...
  return (
    <aside className="w-64 h-screen fixed left-0 top-0 bg-gray-900 text-white shadow-lg p-6">
